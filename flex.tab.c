...
#ifndef YY_YY_FLEX_TAB_H_INCLUDED
# define YY_YY_FLEX_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_FLEX_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "NUM", "SUM", "SUB", "MUL", "DIV", "POW",
  "ABS", "EOL", "$accept", "stms", "stm", "factor", "term", YY_NULLPTR
};
#endif
